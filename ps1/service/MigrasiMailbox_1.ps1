...
foreach ($mb in $mailboxes) {
    ...
    $destinationDb = $mb.DestinationDB
    ...
    try {
        ...
        New-MoveRequest -Identity $upn -TargetDatabase $destinationDb -ArchiveTargetDatabase $destinationDb -BatchName "Migration_$($destinationDb)" -ErrorAction Stop
